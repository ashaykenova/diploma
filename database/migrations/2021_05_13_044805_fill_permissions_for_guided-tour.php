...
class FillPermissionsForGuidedTour extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGuidedTour constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.guided-tour',
            'admin.guided-tour.index',
            'admin.guided-tour.create',
            'admin.guided-tour.show',
            'admin.guided-tour.edit',
            'admin.guided-tour.delete',
            'admin.guided-tour.bulk-delete',
        ]);
